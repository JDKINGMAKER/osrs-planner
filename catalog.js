...
const KEY_ITEMS = [
  ...
  { name: 'Warped sceptre', tags: ['Slayer Unlocks'], access: 4.5,       src: 'Warped creatures (56 Slayer)', match: 'Warped sceptre' },
  { name: 'Dragon boots', tags: ['Slayer Unlocks'], access: 4,         src: 'Spiritual mages', match: 'Dragon boots',
    // Exclude the cosmetic kit, which contains the substring "Dragon boots".
    matchNot: ['ornament kit'] },
  { name: 'Trident of the seas', tags: ['Slayer Unlocks'], access: 5,  src: 'Cave krakens / Kraken boss', match: 'rident of the seas' },
  ...
  { name: 'Occult necklace', tags: ['Slayer Unlocks'], access: 5.5,      src: 'Smoke devils', match: 'Occult necklace' },
  { name: 'Amulet of rancour', tags: ['Slayer Unlocks'], access: 9,    src: 'Combine torture + components', match: 'mulet of rancour' },
  { name: 'Primordial boots', tags: ['Slayer Unlocks'], access: 7,     src: 'Cerberus (primordial crystal)', match: 'Primordial boots' },
  ...
  { name: 'Noxious halberd', tags: ['Slayer Unlocks'], access: 8.5,      src: "Araxxor (noxious components)", match: 'Noxious halberd' },
  ...
  { name: 'Horn of plenty', tags: ['Slayer Unlocks'], access: 5,       src: 'Forestry (anima bark)', match: 'Horn of plenty' },
