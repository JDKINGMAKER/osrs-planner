...
const KEY_ITEMS = [
  ...
  { name: 'Amulet of glory', access: 1.5,      src: 'Edgeville lvl-3 / Heroes Quest', match: 'mulet of glory' },
  ...
  { name: 'Rune crossbow', access: 2.5,        src: 'Fletch / Armadyl crossbow path', match: 'Rune crossbow' },
